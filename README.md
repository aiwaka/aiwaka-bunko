...
<table>
  ...
  <tr>
    ...
    <td>
    <ul>
    <li>Firebase Authentication のオブザーバーを設定したことでログインを検知して動的にヘッダーの内容を変更できるようになった.</li>
    <li>Firestore のコンバーターを挟んだことで保守性が大幅に上がった（実際バグも発見した）.</li>
    <li>お気に入りのピンはsvgデータで, useタグを使って複製しているため可搬性が高く軽量.</li>
